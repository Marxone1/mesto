...
let inputUsername = popup.querySelector(".popup__container-form-input_text_username");
let inputProfession = popup.querySelector(".popup__container-form-input_text_profession");
function openPopup (){
