...
export const username = document.querySelector('.profile__info-username').textContent
export const profession = document.querySelector('.profile__info-profession').textContent
